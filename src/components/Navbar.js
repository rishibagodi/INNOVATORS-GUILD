          ...
          <div className="md:hidden flex items-center space-x-2">
            ...
            <Link href="/cart" className="relative p-2">
              <svg className="w-6 h-6 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-1.8 5.2a1 1 0 01-.9.8H4m1-6h10m-10 0V9a1 1 0 011-1h2m0 0V7a1 1 0 011-1h2m-3 3h6" />
              </svg>
              {itemCount > 0 && (
