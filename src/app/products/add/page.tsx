    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-gray-50">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">Add New Product</h1>
          
          <ProductForm onSubmit={handleSubmit} />
          
          <button
            onClick={() => router.back()}
            className="w-full mt-4 bg-gray-300 text-gray-700 py-2 px-4 rounded-md hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 font-medium transition-all duration-200 hover:scale-105 active:scale-95"
          >
            Cancel
          </button>
        </div>
